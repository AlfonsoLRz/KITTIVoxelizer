...
protected:
	...
	bool							_showDirectoryDialog;				//!< Opens a file dialog to select a directory
	...
	bool							_showVoxelizationSettings;			//!< 
...
protected:
	...
	*/
	...
	/**
	*	@brief Shows a dialog to select a directory.
	*/
	...
	*/
	...
	/**
	*	@brief Shows settings concerning the voxelization of input point clouds.
	*/
	void showVoxelizationSettings();
